...
def main():
    ...
    usuario.telefone = input("Informe telefone do usuário: ").strip()
    ...
    empresa.telefone = input("Informe telefone da empresa: ").strip()

    limpar()

    print(f"O nome do usuário: {usuario.nome}")
    print(f"CPF do usuário: {usuario.cpf}")
    print(f"E-mail do usuário: {usuario.email}")
    print(f"Telefone do usuário: {usuario.telefone}")
    
    print(f"Nome da empresa: {empresa.__nome_fantasia}")
